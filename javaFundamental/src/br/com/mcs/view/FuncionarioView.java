...
public class FuncionarioView implements ActionListener{
	...
	private JLabel lFuncao= new JLabel("Fun��o:   ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (origem == bConsultar){
			...
			if(total > 0){
				JOptionPane.showMessageDialog(janela, "Opera��o realizada com Sucesso!");
			}else {
				JOptionPane.showMessageDialog(janela, "N�o foi poss�vel efetuar a opera��o!");
			}//fim do segundo if
	...
	public boolean validaCampos() {
		if (tRegistro.getText().trim().equals("")) {
			JOptionPane.showMessageDialog(janela, "Para cadastrar digite o C�digo do Resgistro");
			return false;
		}
